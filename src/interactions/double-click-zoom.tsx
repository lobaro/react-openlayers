...
class DoubleClickZoom extends React.Component<any, any> {
...
export default props => <MapContext.Consumer>{mapComp => <DoubleClickZoom {...props} mapComp={mapComp} />}</MapContext.Consumer>
